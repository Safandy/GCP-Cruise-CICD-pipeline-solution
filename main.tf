...
resource "google_compute_instance" "iac-project-cicd-server" {
  ...
  network_interface {
    ...
    subnetwork  = "projects/cruisecicdpipeline/regions/us-east1/subnetworks/default"
  }
  ...
  service_account {
    email  = "sa-64-897@cruisecicdpipeline.iam.gserviceaccount.com"
